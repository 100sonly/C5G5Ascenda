...
const ColorlibConnector = styled(StepConnector)(({ theme }) => ({
  ...
  [`&.${stepConnectorClasses.active}`]: {
    [`& .${stepConnectorClasses.line}`]: {
      backgroundImage:
        'linear-gradient(95deg, #1a1e43 0%, #2b2f5c 50%, #3c459b 100%)', // Gradient based on #1a1e43
    },
  },
...
const ColorlibStepIconRoot = styled('div')(({ theme, ownerState }) => ({
  ...
  ...(ownerState.active && {
    backgroundImage:
      'linear-gradient(136deg, #1a1e43 0%, #2b2f5c 50%, #3c3f7b 100%)', // Gradient based on #1a1e43
